...
const SignIn = () => {
  ...
  if (location.pathname)
    return (
      <div className="">
        {/* <Helmet>
        <title>MyBali-Login</title>
      </Helmet> */}
        <div className="flex justify-center items-center mt-5">
          <div className="w-[80%] p-8 space-y-3 rounded-xl dark:bg-gray-100 dark:text-gray-800 ">
            ...
            >
              ...
              >
                <div className="relative">
                  ...
                  <p className="absolute text-xl top-9 text-[#23BF9B] left-2">
                    <MdEmail />
                  </p>
                </div>
                <input
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="absolute text-xl text-[#23BF9B] top-3 left-2 ">
                    <FaKey />
                  </p>
                  <p
            ...
            <div className="flex justify-center space-x-4">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 32 32"
                  className="w-5 text-[#23BF9B] h-5 fill-current"
                >
            ...
            <p className="text-xs text-center sm:px-6 dark:text-gray-600">
              ...
              <Link
                to="/register"
                className="underline text-[#23BF9B] font-bold "
              >
                Register
              </Link>
            </p>
